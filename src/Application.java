...
public class Application {
    ...
    public static void main(String[] args) {
       ...
       // Configuration propeties = Configuration.getInstance();
        ...
        Product product2 = new Product("Pent", 6., 100);
        ...
        writering.writer("product.csv",listProduct);

      //  writering.CvsWriter(cvsFileName,listProduct);

        FileRead reading = new FileRead();
        Map<Integer, Product> listProductCopy = new HashMap<>();
        reading.copy(cvsFileName,listProductCopy);
